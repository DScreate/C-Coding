 ...
 */
/**
 * Lo and behold, the fileUtil code we created has been invoked once more
 * As before, it contains the methods we've been using up to this point but
 * also now has one to run the USHRC file, a method to open said file and then
 * a method to assist with managing our history for the shell
 */
#ifndef UTILS_FILEUTIL_H_
#define UTILS_FILEUTIL_H_
